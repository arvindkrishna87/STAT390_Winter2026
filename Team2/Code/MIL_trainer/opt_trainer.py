"""
Training and validation logic for MIL model for use for Optuna code
"""
import os
import torch
...
class MILTrainer2:
    ...
    # edited this line to pass the optuna hyperparams through 
    def __init__(self, model, device, learning_rate, weight_decay, checkpoint_dir=None):
        self.model = model
        ...
        self.optimizer = optim.AdamW(
            ...
            lr=learning_rate, # edited from lr=TRAINING_CONFIG['learning_rate'], to accept the optuna
            weight_decay=weight_decay #edited from weight_decay=TRAINING_CONFIG['weight_decay'] to accept the optuna
        )
