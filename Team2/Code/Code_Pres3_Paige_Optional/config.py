...
TRAINING_CONFIG = {
    ...
    'early_stopping_min_epochs': 30,  # Minimum epochs before early stopping can trigger
    'entropy_lambda': 1e-5, # Entropy regularization for attention (encourages diverse attention)
    #^^2 edits from roma's mandatory change
}
