...
EXCLUDE_FROM_TEST_DEFAULT = {22, 107, 108, 26, 109, 110, 111, 24, 118, 25, 119}
...
def split_by_case_with_constraints(
    ...
    test_benign = [45, 46, 53, 56, 77, 78, 79]
...
def main():
    ...
    out_path = os.path.join(args.save_dir, "xiaolin_split4.npz")
    print("\n" + "=" * 80)
    print("DONE")
    print("=" * 80)
