...
DATA_PATHS = {
    'labels_csv': '/projects/e32998/STAT390_Winter2026/Data/case_grade_match.csv', #updating path to case_grade_match.csv
...
TRAINING_CONFIG = {
    ...
    'entropy_lambda': 1e-3,   # starting small, can be tuned
