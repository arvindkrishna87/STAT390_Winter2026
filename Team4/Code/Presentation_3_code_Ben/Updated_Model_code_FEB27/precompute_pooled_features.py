...
def main():
    ...
    ap.add_argument("--patches_dir", default="/home/bdp1083/Presentation_3_code/patches_benign_split", help="Folder with PNG patches")
    ap.add_argument("--embeddings_dir", default="/home/bdp1083/Presentation_3_code/patches_pooled4096", help="Where to save .pt features")
    ap.add_argument("--kimianet_ckpt", default="/home/bdp1083/Presentation_3_code/Updated_Model_code/KimiaNet.pth", help="KimiaNet checkpoint path")
