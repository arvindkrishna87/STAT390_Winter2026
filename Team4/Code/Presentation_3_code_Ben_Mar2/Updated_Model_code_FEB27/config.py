...
#Round 3 of OPTUNA with separate dropout for patch projector and classifier
OPTUNA_BEST_PARAMS_3 = {
    "learning_rate": 1.0994335574766187e-05,
    "weight_decay": 0.008123245085588688,
    "project_dropout": 0.1749,
    "classifier_dropout": 0.0819,
    "class_weight_benign": 1.8636, 
...
TRAINING_CONFIG = {
    ...
    'learning_rate': OPTUNA_BEST_PARAMS_3["learning_rate"],  # Updated from OPTUNA study
    'weight_decay': OPTUNA_BEST_PARAMS_3["weight_decay"],  # Updated from OPTUNA study
    'num_workers': 2,
    'pin_memory': True,
    'random_state': 42,
    'class_weights': [OPTUNA_BEST_PARAMS_3["class_weight_benign"], 1.0],  # Increased benign weight from 2.0 to 2.5285 (from OPTUNA study)
    #Dropout for regularization
    'classifier_dropout': OPTUNA_BEST_PARAMS_3["classifier_dropout"],  # Add dropout for regularization
    'project_dropout': OPTUNA_BEST_PARAMS_3["project_dropout"],  # Add dropout for regularization in patch projector
    ...
    'scheduler_min_lr': OPTUNA_BEST_PARAMS_3["scheduler_min_lr"],  # Minimum LR for scheduler from OPTUNA study
    # Early stopping
    'early_stopping': True,
