...
class StainBagCaseDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        stain_slices: Dict[str, List[List[torch.Tensor]]] = {}
        for stain in self.stains:
            ...
            tensors_for_stain: List[List[torch.Tensor]] = []
        ...
        return {
            "case_id": case_id,
            "stain_slices": stain_slices,  # dict[stain] -> list[list[Tensor(C,H,W)]]
            "label": label,
        }
