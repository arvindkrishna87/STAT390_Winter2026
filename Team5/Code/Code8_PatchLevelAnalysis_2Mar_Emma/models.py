...
class HierarchicalAttnMIL(nn.Module):
    ...
    def __init__(
        ...
        # Attention modules
        self.patch_attention = AttentionPool(embed_dim, MODEL_CONFIG["attention_hidden_dim"], dropout=0.0)
        self.stain_attention = AttentionPool(embed_dim, MODEL_CONFIG["attention_hidden_dim"], dropout=0.0)
        self.case_attention  = AttentionPool(embed_dim, MODEL_CONFIG["attention_hidden_dim"], dropout=0.0)
