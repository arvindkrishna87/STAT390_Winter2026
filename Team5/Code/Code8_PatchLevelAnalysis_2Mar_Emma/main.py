...
def main():
    ...
    if os.path.exists(pred_csv):
        ...
        id_col   = next((c for c in pred_df.columns if "case" in c), None)
        pred_col = next((c for c in pred_df.columns if "pred" in c and "label" in c), None) or \
                next((c for c in pred_df.columns if "pred" in c), None)
