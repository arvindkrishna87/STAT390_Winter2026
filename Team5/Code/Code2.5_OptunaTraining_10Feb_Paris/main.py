...
def create_data_loaders(train_data, val_data, test_data, args):
    ...
    train_loader = DataLoader(
        train_ds, batch_size=args.batch_size, shuffle=True, persistent_workers=True, # added persistent worker=True
        num_workers=args.num_workers, pin_memory=True, collate_fn=case_collate_fn
    )
    
    val_loader = DataLoader(
        val_ds, batch_size=args.batch_size, shuffle=False, persistent_workers=True, # added persistent worker=True
        num_workers=args.num_workers, pin_memory=True, collate_fn=case_collate_fn
    )
    
    test_loader = DataLoader(
        test_ds, batch_size=args.batch_size, shuffle=False, persistent_workers=True, # added persistent worker=True
        num_workers=args.num_workers, pin_memory=True, collate_fn=case_collate_fn
    )
