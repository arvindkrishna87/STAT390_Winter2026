...
def main():
    ...
    # Apply patch projector dropout separately (index 2: Linear=0, ReLU=1, Dropout=2)
    if TRAINING_CONFIG.get('coeff_dropout') is not None:
        import torch.nn as nn
        model.patch_projector[2] = nn.Dropout(TRAINING_CONFIG['coeff_dropout'])
